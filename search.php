	...
	<form action="<?php echo !empty($args['search_url']) ? esc_url($args['search_url']) : EM_URI; ?>" method="post" class="em-search-form" id="em-search-form-<?php echo $id; ?>">
		...
		<?php if ( $args['show_main'] ) : //show the 'main' search form ?>
			<div class="em-search-main em-search-main-bar">
				...
				if( !empty($args['search_term_main']) ) em_locate_template('templates/search/search.php',true,array('args'=>$args)); // Keyword search
				if( !empty($args['search_scope_main']) ) em_locate_template('templates/search/scope.php',true,array('args'=>$args)); // Scope, aka date range
				$args['id'] = $id;
				?>
